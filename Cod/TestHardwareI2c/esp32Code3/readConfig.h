...
extern String sensorIDs[4];  // Array for 4 unique sensor IDs
extern String ssid;
...
public:
    ...
    void setDefaults() {
        ...
        prefs.putString("sensorID_1", "sensor_lab_3_01");
        prefs.putString("sensorID_2", "sensor_lab_3_02");
        prefs.putString("sensorID_3", "sensor_lab_3_03");
        prefs.putString("sensorID_4", "sensor_lab_3_04");
    ...
    void load() {
        ...
        sensorIDs[0]  = prefs.getString("sensorID_1", "sensor_lab_3_01");
        sensorIDs[1]  = prefs.getString("sensorID_2", "sensor_lab_3_02");
        sensorIDs[2]  = prefs.getString("sensorID_3", "sensor_lab_3_03");
        sensorIDs[3]  = prefs.getString("sensorID_4", "sensor_lab_3_04");
    ...
    void setSensorID(int index, const String& val) {
        if (index >= 0 && index < 4) {
            String key = "sensorID_" + String(index + 1);
